...
public class MappingAdminTest {
  ...
  public void setUp() {
    ...
    when( mockHBaseService.getByteConversionUtil() ).thenReturn( mockByteConversionUtil );
    when( mockHbaseConnection.getService() ).thenReturn( mockHBaseService);
  ...
  private void setupMappingStructure() throws Exception {
    ...
    when( mockHBaseService.getHBaseValueMetaInterfaceFactory() ).thenReturn( hBaseValueMetaInterfaceFactory );
    MappingFactory mappingFactory = new MappingFactoryImpl( hBaseBytesUtilShim, hBaseValueMetaInterfaceFactory );
    when( mockHBaseService.getMappingFactory() ).thenReturn( mappingFactory );
