...
@ExtensionPoint( id = "NewHadoopClusterViewTreeExtension", description = "",
  extensionPointId = "SpoonViewTreeExtension" )
public class NewHadoopClusterViewTreeExtension implements ExtensionPointInterface {

  private NewHadoopClusterDelegate newHadoopClusterDelegate;

  public NewHadoopClusterViewTreeExtension( NewHadoopClusterDelegate newHadoopClusterDelegate ) {
...
//      if ( selectionTreeExtension.getSelection() instanceof NewHadoopClusterTreeItem ) {
//        NewHadoopClusterTreeItem newHadoopClusterTreeItem = (NewHadoopClusterTreeItem) selectionTreeExtension.getSelection();
//        newHadoopClusterDelegate.openDialog( newHadoopClusterTreeItem.getLabel() );
//      }
//    }
  }
}
