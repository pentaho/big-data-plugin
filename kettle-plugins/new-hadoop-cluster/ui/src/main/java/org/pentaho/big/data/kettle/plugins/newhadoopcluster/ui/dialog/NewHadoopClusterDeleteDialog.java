 ...
 */
public class NewHadoopClusterDeleteDialog extends Dialog {

  private static Class<?> PKG = NewHadoopClusterDeleteDialog.class;
  ...
  public NewHadoopClusterDeleteDialog( Shell shell ) {
    super( shell );
