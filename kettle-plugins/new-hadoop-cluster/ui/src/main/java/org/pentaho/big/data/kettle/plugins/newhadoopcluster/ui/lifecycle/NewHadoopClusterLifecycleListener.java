...
//  private Supplier<ConnectionManager> connectionManagerSupplier = ConnectionManager::getInstance;
  ...
  public NewHadoopClusterLifecycleListener( MetastoreLocator metastoreLocator ) {
  ...
  public void onStart( LifeEventHandler handler ) throws LifecycleException {
    ...
    if ( spoon != null ) {
      spoon.getTreeManager().addTreeProvider( Spoon.STRING_TRANSFORMATIONS, new NewHadoopClusterFolderProvider( metastoreLocator ) );
      spoon.getTreeManager().addTreeProvider( Spoon.STRING_JOBS, new NewHadoopClusterFolderProvider( metastoreLocator ) );
