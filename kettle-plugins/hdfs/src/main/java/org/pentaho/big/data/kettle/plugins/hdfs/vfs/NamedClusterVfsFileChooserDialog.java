...
public class NamedClusterVfsFileChooserDialog extends CustomVfsUiPanel {
  ...
  String schemeName = "namedcluster";
  ...
  public void activate() {
    ...
    vfsFileChooserDialog.openFileCombo.setText( "namedcluster://" );
  ...
  public void connect() {
    ...
    try {
      builder.setParameter( fsoptions, NAMED_CLUSTER_FS_OPTION, nc.toXmlForEmbed( NAMED_CLUSTER_XML_TAG ),
        "vfs." + nc.getStorageScheme() + "." + NAMED_CLUSTER_FS_OPTION, connectionString );
