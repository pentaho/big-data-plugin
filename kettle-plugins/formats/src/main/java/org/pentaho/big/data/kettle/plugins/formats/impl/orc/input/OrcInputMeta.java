...
@InjectionSupported( localizationPrefix = "OrcInput.Injection.", groups = { "FIELDS" }, hide = {
        ...
        "FILE_URI_FIELDNAME", "FILE_ROOT_URI_FIELDNAME", "FILENAME", "FIELD_IF_NULL", "FIELD_NULL_STRING",
        "FIELD_NULLABLE", "FIELD_SOURCE_TYPE"
} )
