...
public class ImpalaSimbaDriverTest {
  ...
  public void testCheckBeforeCallActiveDriverHiveMatchMissing() throws SQLException {
    assertNull(
      impalaSimbaDriver.checkBeforeCallActiveDriver( "jdbc:impal:a;" + ImpalaSimbaDriver.SIMBA_SPECIFIC_URL_PARAMETER ) );
  }

  @Test
  public void testCheckBeforeCallActiveDriver() throws SQLException {
    assertEquals( delegate,
      impalaSimbaDriver.checkBeforeCallActiveDriver( "jdbc:impala:a;" + ImpalaSimbaDriver.SIMBA_SPECIFIC_URL_PARAMETER ) );
  }
}
