...
public class MaprJaasRealmRegistrarTest {
  ...
  public void setup() throws ConfigurationException {
    ...
    doCallRealMethod().when( testee ).onConfigurationOpen( any( HadoopConfiguration.class ), anyBoolean() );
  ...
  public void testIgnoresNotMaprShims() throws ConfigurationException {
    ...
    testee.onConfigurationOpen( createHadoopConfiguration( "Shim for cdh or hdp or whatever hadoop distro" ), true );
  ...
  public void testRegistersAndUnregistersRealms() {
    ...
    testee.onConfigurationOpen( hadoopConf, true );
