...
public class JaasConfigServiceLoader implements HadoopConfigurationListener {
  public static final String SHIMCONFIG_SERVICE_FACTORY_CANONICAL_NAME = JaasConfigServiceFactory.class.getCanonicalName();
  private static final Logger LOGGER = LoggerFactory.getLogger( JaasConfigServiceLoader.class );
  private final BundleContext bundleContext;
  private final ShimBridgingServiceTracker shimBridgingServiceTracker;

  public JaasConfigServiceLoader( BundleContext bundleContext,
    ...
    try {
      ...
      LOGGER.error(
        BaseMessages.getString(
          JaasConfigServiceLoader.class, "jaas.config.service.load.error", hadoopConfiguration.getIdentifier() ) );
    }
  }
