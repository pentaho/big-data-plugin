...
public class HBaseValueMetaInterfaceFactoryImplTest {
  ...
  public void setUp() throws Exception {
    HBaseBytesUtilShim hBaseBytesUtilShim = Mockito.mock( HBaseBytesUtilShim.class );
  ...
  public void testCopyIsLongOrDoubleType() throws Exception {
    ...
    for ( HBaseValueMeta metaToCopy : metaToCopyList ) {
      ...
      Assert.assertEquals( metaToCopy.getType(), metaAfterCopy.getType() );
      Assert.assertEquals( metaToCopy.getIsLongOrDouble(), metaToCopy.getIsLongOrDouble() );
      Assert.assertEquals( metaToCopy.getHBaseTypeDesc(), metaAfterCopy.getHBaseTypeDesc() );
    }
  }
