...
package org.pentaho.hadoop.shim.hdp12;
...
public class ShimRegistrationTest {
  ...
  public void hadoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.hdp12.HadoopShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void sqoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.hdp12.ClassPathModifyingSqoopShim.class.equals(s.getClass()));
  }
  ...
  public void snappyShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.hdp12.SnappyShim.class.isAssignableFrom(s.getClass()));
  }
