...
package org.pentaho.hadoop.shim.cdh413;
...
public class ShimRegistrationTest {
  ...
  public void hadoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.cdh413.HadoopShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void sqoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.cdh413.ClassPathModifyingSqoopShim.class.equals(s.getClass()));
  }
  ...
  public void snappyShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.cdh413.SnappyShim.class.isAssignableFrom(s.getClass()));
  }
