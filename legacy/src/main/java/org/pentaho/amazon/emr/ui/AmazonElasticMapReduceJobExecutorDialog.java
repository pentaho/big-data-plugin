...
public class AmazonElasticMapReduceJobExecutorDialog extends JobEntryDialog implements JobEntryDialogInterface {
  ...
  public AmazonElasticMapReduceJobExecutorDialog( Shell parent, JobEntryInterface jobEntry, Repository rep,
    ...
    bf.createBinding(
        "jobentry-hadoopjob-name", "value", controller, AmazonElasticMapReduceJobExecutorController.HADOOP_JOB_NAME ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    bf.createBinding(
        "jobentry-hadoopjob-flow-id", "value", controller, AmazonElasticMapReduceJobExecutorController.HADOOP_JOB_FLOW_ID ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    bf.createBinding(
        "s3-staging-directory", "value", controller, AmazonElasticMapReduceJobExecutorController.STAGING_DIR ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

    bf.setBindingType( Type.ONE_WAY );
    bf.createBinding(
        "s3-staging-directory", "value", controller, AmazonElasticMapReduceJobExecutorController.STAGING_DIR_FILE, stagingDirBinding ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    bf.createBinding(
        "master-instance-type", "selectedItem", controller, AmazonElasticMapReduceJobExecutorController.MASTER_INSTANCE_TYPE ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    bf.createBinding(
        "slave-instance-type", "selectedItem", controller, AmazonElasticMapReduceJobExecutorController.SLAVE_INSTANCE_TYPE ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

    bf.createBinding(
        "command-line-arguments", "value", controller, AmazonElasticMapReduceJobExecutorController.CMD_LINE_ARGS ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    XulMenuList<String> masterInstanceType =
        (XulMenuList<String>) container.getDocumentRoot().getElementById( "master-instance-type" );
    masterInstanceType.setSelectedItem( "" + controller.getMasterInstanceType() );

    XulMenuList<String> slaveInstanceType =
        (XulMenuList<String>) container.getDocumentRoot().getElementById( "slave-instance-type" );
    ...
    bf.createBinding(
        "logging-interval", "value", controller, AmazonElasticMapReduceJobExecutorController.LOGGING_INTERVAL ); //$NON-NLS-1$ //$NON-NLS-2$ 
