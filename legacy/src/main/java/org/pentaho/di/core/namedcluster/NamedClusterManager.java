...
public class NamedClusterManager {
  private static final NamedClusterManager instance =
    new NamedClusterManager( new MetaStoreFactoryFactory(), HadoopConfigurationBootstrap.getInstance() );
  ...
  @VisibleForTesting NamedClusterManager( MetaStoreFactoryFactory metaStoreFactoryFactory,
   ...
   */
  @VisibleForTesting
  String generateURL( String clusterName, IMetaStore metastore, VariableSpace variableSpace ) {
    ...
    if ( namedCluster != null ) {
      if ( namedCluster.isMapr() ) {
        ...
        Properties configProperties =
          hadoopConfigurationBootstrap.getProvider().getActiveConfiguration().getConfigProperties();
