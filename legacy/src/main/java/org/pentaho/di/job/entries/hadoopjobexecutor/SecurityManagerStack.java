 ...
 * {@link #setSecurityManager(SecurityManager)}. To remove a Security Manager use
 * {@link #removeSecurityManager(SecurityManager)}.
 * </p>
 * <p>
...
public class SecurityManagerStack {
  ...
  /**
   * Sets a new Security Manager. This will stash the current Security Manager so it may be restored when
   * {@link #removeSecurityManager(SecurityManager)} with {@code sm} is called.
   * 
   * @param sm
