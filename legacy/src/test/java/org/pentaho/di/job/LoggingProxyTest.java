...
public class LoggingProxyTest {
  ...
  /**
   * Make sure the logging proxy can wrap a {@link java.io.PrintStream}, e.g. {@link System#out}, and log all messages
   * passed to {@link java.io.PrintStream#print(String)} get logged to the provided {@link Logger}
   */
  @Test
