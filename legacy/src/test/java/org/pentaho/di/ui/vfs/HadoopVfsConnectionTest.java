...
public class HadoopVfsConnectionTest {
  ...
  public void testConstructorWithNamedClusterAsParameter_HostNameNull() {
    NamedCluster testNamedCluster = getTestNamedCluster();
    testNamedCluster.setHdfsHost( null );
  ...
  public void testConstructorWithNamedClusterAsParameter_PortNull() {
    NamedCluster testNamedCluster = getTestNamedCluster();
    testNamedCluster.setHdfsPort( null );
  ...
  public void testConstructorWithNamedClusterAsParameter_UserNull() {
    NamedCluster testNamedCluster = getTestNamedCluster();
    testNamedCluster.setHdfsUsername( null );
  ...
  public void testConstructorWithNamedClusterAsParameter_PasswordNull() {
    NamedCluster testNamedCluster = getTestNamedCluster();
    testNamedCluster.setHdfsPassword( null );
  ...
  private NamedCluster getTestNamedCluster() {
    NamedCluster nCluster = NamedClusterManager.getInstance().getClusterTemplate();
    nCluster.setHdfsHost( TEST_HOST );
    nCluster.setHdfsPort( TEST_PORT );
    nCluster.setHdfsUsername( TEST_USER );
    nCluster.setHdfsPassword( TEST_PASSWORD );
    return nCluster;
  }
