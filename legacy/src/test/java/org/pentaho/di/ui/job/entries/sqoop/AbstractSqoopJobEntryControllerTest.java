...
public class AbstractSqoopJobEntryControllerTest {
  ...
  private class TestSqoopJobEntryController extends
      AbstractSqoopJobEntryController<SqoopConfig, AbstractSqoopJobEntry<SqoopConfig>> {
    ...
    TestSqoopJobEntryController( XulDeck modeDeck, XulDeck advancedModeDeck, XulButton advancedListButton,
        XulButton advancedCommandLineButton ) {
  ...
  public void populateDatabases() throws XulException, InvocationTargetException {
    ...
    controller.getJobMeta()
        .addDatabase( new DatabaseMeta( test.getName(), "MYSQL", null, null, null, null, null, null ) );
    controller.populateDatabases();
  ...
  /**
   * Make sure that setting the selected database to and from
   * {@link AbstractSqoopJobEntryController#USE_ADVANCED_OPTIONS} will properly set the
   * {@code database, connect, username, and password} fields according to advanced settings or not.
   * 
  ...
  public void updateUiMode() {
    ...
    AbstractSqoopJobEntryController controller =
        new TestSqoopJobEntryController( modeDeck, advancedModeDeck, advancedListButton, advancedCommandLineButton );
  ...
  public void setUiMode_exception_parsing_command_line() {
    ...
    XulButton advancedListButton = new MockXulButton();
    XulButton advancedCommandLineButton = new MockXulButton();
    TestSqoopJobEntryController controller =
        new TestSqoopJobEntryController( modeDeck, advancedModeDeck, advancedListButton, advancedCommandLineButton );
    ...
    assertEquals( BaseMessages.getString( AbstractSqoopJobEntry.class, "ErrorConfiguringFromCommandLine" ),
        controller.shownErrors.get( 0 )[1] );
  ...
  public void setUiMode() {
    ...
    assertEquals( -1, advancedModeDeck.getSelectedIndex() );
    assertEquals( BaseMessages.getString( AbstractSqoopJobEntry.class, "Sqoop.JobEntry.AdvancedOptions.Button.Text" ),
        controller.getModeToggleLabel() );

    controller.setUiMode( JobEntryMode.ADVANCED_LIST );
    assertEquals( 1, modeDeck.getSelectedIndex() );
    assertEquals( 0, advancedModeDeck.getSelectedIndex() );
    assertEquals( BaseMessages.getString( AbstractSqoopJobEntry.class, "Sqoop.JobEntry.QuickSetup.Button.Text" ),
        controller.getModeToggleLabel() );
