...
public enum RuntimeTestEntrySeverity {
  ...
  public static RuntimeTestEntrySeverity maxSeverityEntry(
    Collection<RuntimeTestResultEntry> runtimeTestResultEntries ) {
    RuntimeTestEntrySeverity maxSeverity = null;
    for ( RuntimeTestResultEntry runtimeTestResultEntry : runtimeTestResultEntries ) {
      RuntimeTestEntrySeverity severity = runtimeTestResultEntry.getSeverity();
  ...
  public static RuntimeTestEntrySeverity maxSeverityResult( Collection<RuntimeTestResult> runtimeTestResults ) {
    ...
    for ( RuntimeTestResult runtimeTestResult : runtimeTestResults ) {
      RuntimeTestEntrySeverity severity = runtimeTestResult.getMaxSeverity();
      if ( maxSeverity == null || ( severity != null && severity.ordinal() > maxSeverity.ordinal() ) ) {
        maxSeverity = severity;
      }
    }
