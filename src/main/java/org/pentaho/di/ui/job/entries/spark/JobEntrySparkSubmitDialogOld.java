 ...
 * @since Dec-4-2014
 */
public class JobEntrySparkSubmitDialogOld extends JobEntryDialog implements JobEntryDialogInterface {
  ...
  public JobEntrySparkSubmitDialogOld( Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta ) {
  ...
  public static void main( String[] args ) {
    ...
    JobEntrySparkSubmitDialogOld dialog =
        new JobEntrySparkSubmitDialogOld( shell, new JobEntrySparkSubmit( "Spark submit job entry" ), null, new JobMeta() );
