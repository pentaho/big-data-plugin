...
public class JobEntryHadoopTransJobExecutorDialog extends JobEntryDialog implements JobEntryDialogInterface {
  ...
  public JobEntryHadoopTransJobExecutorDialog( Shell parent, JobEntryInterface jobEntry, Repository rep,
                                               JobMeta jobMeta ) throws XulException, DocumentException, Throwable {
    ...
    container = swtXulLoader
      .loadXul( "org/pentaho/di/ui/job/entries/hadooptransjobexecutor/JobEntryHadoopTransJobExecutorDialog.xul",
        bundle ); //$NON-NLS-1$
    ...
    bf.createBinding( "jobentry-name", "value", controller,
      JobEntryHadoopTransJobExecutorController.JOB_ENTRY_NAME ); //$NON-NLS-1$ //$NON-NLS-2$
 ...
 /*   final BindingConvertor<String, Integer> bindingConverter = new BindingConvertor<String, Integer>() {
    ...
    bf.createBinding( "num-map-tasks", "value", controller,
      JobEntryHadoopTransJobExecutorController.NUM_MAP_TASKS ); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    bf.createBinding( "blocking", "selected", controller,
      JobEntryHadoopTransJobExecutorController.BLOCKING ); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    bf.createBinding( "input-path", "value", controller,
      JobEntryHadoopTransJobExecutorController.INPUT_PATH ); //$NON-NLS-1$ //$NON-NLS-2$
    bf.createBinding( "output-path", "value", controller,
      JobEntryHadoopTransJobExecutorController.OUTPUT_PATH ); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    bf.createBinding( "hdfs-hostname", "value", controller,
      JobEntryHadoopTransJobExecutorController.HDFS_HOSTNAME ); //$NON-NLS-1$ //$NON-NLS-2$
    bf.createBinding( "hdfs-port", "value", controller,
      JobEntryHadoopTransJobExecutorController.HDFS_PORT ); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    XulTextbox loggingInterval =
      (XulTextbox) container.getDocumentRoot().getElementById( "logging-interval" ); //$NON-NLS-1$
    ...
    XulTextbox reduceTasks =
      (XulTextbox) container.getDocumentRoot().getElementById( "num-reduce-tasks" ); //$NON-NLS-1$
